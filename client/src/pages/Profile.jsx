...
useEffect(() => { 
 ...
 // Fetch user
  const fetchUser = async () => {
    if (!token) return;
    try {
      const res = await fetch("https://expense-splitter-nsts.onrender.com/users/me", {
...
// Update name
  const handleUpdate = async () => {
    ...
    try {
      const res = await fetch("https://expense-splitter-nsts.onrender.com/users/update-name", {
        method: "PUT",
...
const handleAvatarChange = async (e) => {
    ...
    try {
      const res = await fetch("https://expense-splitter-nsts.onrender.com/users/avatar", {
        method: "PUT",
        headers: { Authorization: `Bearer ${token}` },
        body: formData,
      });
