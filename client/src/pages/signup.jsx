  ...
  return (
    <>
      ...
      <div className="flex min-h-screen overflow-hidden bg-gray-100">
        {/* Left Panel */}
        <div className="hidden lg:flex lg:w-3/5 bg-black text-white flex-col justify-center p-12 xl:p-16 h-screen">
          <div className="flex flex-col justify-center h-full space-y-10">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-400 leading-relaxed">
                Join thousands of users who trust SplitMate to manage their shared expenses. It only takes a minute to get started.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <Feature
                ...
                icon={<path d="M12 21C12 21 5 14.686 5 9.5a7 7 0 0 1 14 0c0 5.186-7 11.5-7 11.5z" />}
              />
              <Feature
                title="Always Free"
                desc="Core features are free forever."
                icon={<path d="M12 2a10 10 0 1 0 10 10A10.011 10.011 0 0 0 12 2Zm1 15h-2v-2h2Zm0-4h-2V7h2Z" />}
              />
            </div>
          </div>
        </div>
        ...
        {/* Right Panel */}
        <div className="flex-1 flex justify-center items-center h-screen px-6 py-9">
          <div className="w-full max-w-md mr-auto bg-white rounded-lg shadow-lg border border-gray-200 p-8 md:p-10 flex flex-col justify-center">
            <div className="flex flex-col justify-center space-y-6 h-full">
              {/* Header */}
              <div className="text-center">
                <h2 className="text-2xl font-bold text-gray-900">Create your account</h2>
                <p className="text-gray-500 mt-1">Join SplitMate and start managing expenses effortlessly</p>
              </div>

              {/* Form */}
              <form onSubmit={handleSignup} className="space-y-4">
                <InputField id="name" label="Full Name" type="text" value={name} setValue={setName} placeholder="John Doe" />
                <InputField id="email" label="Email Address" type="email" value={email} setValue={setEmail} placeholder="you@example.com" />
                <InputField id="password" label="Password" type="password" value={password} setValue={setPassword} placeholder="Create a strong password" />
